        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2">
              ...
              <div className="inline-flex items-center rounded-2xl bg-violet-600 px-3 py-2 text-xs text-white dark:bg-violet-500">
                <Skeleton className="h-3 w-20 rounded-full bg-white/50" />
              </div>
            </div>
          </div>
...
export default function Loading() {
  return (
    <div className="min-h-dvh bg-gradient-to-b from-violet-50/60 to-background dark:from-violet-950/20">
      {/* Header (matches your PageHeader footprint) */}
      <div className="sticky top-0 z-20 border-b border-violet-200/40 bg-white/60 backdrop-blur-[6px] dark:border-violet-500/10 dark:bg-zinc-950/40">
        <div className="mx-auto flex w-full max-w-md items-center justify-between px-3 py-3">
          ...
          >
            <Inbox className="mr-1 h-4 w-4 opacity-70" />
        ...
        <Card className="rounded-3xl border border-violet-200/60 bg-white/60 backdrop-blur-[2px] dark:border-violet-500/15 dark:bg-zinc-950/40">
          <CardContent className="p-4">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex h-12 items-center rounded-2xl bg-white/60 p-1 backdrop-blur-[2px] dark:bg-zinc-950/40">
                <Skeleton className="h-10 w-24 rounded-2xl" />
                <Skeleton className="ml-1 h-10 w-20 rounded-2xl" />
              </div>
            </div>
          </CardContent>
        </Card>

        {/* Add items trigger skeleton */}
        <Card className="rounded-3xl border border-violet-200/60 bg-white/60 backdrop-blur-[2px] dark:border-violet-500/15 dark:bg-zinc-950/40">
          <CardContent className="p-4">
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
